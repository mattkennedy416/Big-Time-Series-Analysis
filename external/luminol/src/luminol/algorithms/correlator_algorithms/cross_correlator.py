...
"""
from external.luminol.src.luminol.algorithms.correlator_algorithms import CorrelatorAlgorithm
from external.luminol.src.luminol.modules.correlation_result import CorrelationResult
from external.luminol.src.luminol.constants import (DEFAULT_SHIFT_IMPACT,
